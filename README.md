...
| :--- | :--- | :--- |
| **🪟 Windows** | [**Download Installer**](https://github.com/selrahcDC/cjsoftware-license-checker/releases/latest/download/CJSoftware%20License%20Checker-Setup.exe) | `.exe` (Installer) |
| **🪟 Windows** | [**Download Portable**](https://github.com/selrahcDC/cjsoftware-license-checker/releases/latest/download/CJSoftware%20License%20Checker-Portable.exe) | `.exe` (Click-and-Run) |
| **🍎 macOS (Apple Silicon)** | [**Download DMG**](https://github.com/selrahcDC/cjsoftware-license-checker/releases/latest/download/CJSoftware%20License%20Checker-arm64.dmg) | `.dmg` (Universal) |
| **🍎 macOS (Intel)** | [**Download DMG**](https://github.com/selrahcDC/cjsoftware-license-checker/releases/latest/download/CJSoftware%20License%20Checker-x64.dmg) | `.dmg` (x64) |
